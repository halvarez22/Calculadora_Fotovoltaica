...
// Voltaic Logo - Usando la imagen del logo corporativo
export const VoltaicIcon: React.FC<IconProps> = (props) => {
    const { className = '', ...rest } = props;
    return (
        <img 
            src="/images/logo-voltaic.png" 
            alt="Voltaic Logo" 
...
// Mantenemos CfeIcon por compatibilidad, pero ahora usaremos VoltaicIcon
export const CfeIcon = VoltaicIcon;
...
export const ChartIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M3 3v18h18"></path><path d="M18.7 8a6 6 0 0 0-6.4 0l-4.3 4.3a4 4 0 0 0 0 5.6l.6.6a4 4 0 0 0 5.6 0l4.3-4.3a6 6 0 0 0 0-8.4z"></path></svg>
);

export const TableIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="3" y1="15" x2="21" y2="15"></line><line x1="12" y1="3" x2="12" y2="21"></line></svg>
);
